...
const examples = [
  {
    name: "Analytics",
    description: "Core analytics, low level building blocks for your own custom analytics solution.",
    href: "/core",
  },
  {
    name: "Page Views",
  ...
  {
    name: "Auth",
    description: "Full insights into your users. Track signups, logins, and more. ",
    href: "/auth",
  },
];
      ...
      <header className="font-display bg-gradient-to-tr from-neutral-100 via-white to-neutral-200">
        <div className="relative px-6 lg:px-8">
          <div className="max-w-3xl py-12 md:py-24 mx-auto ">
            <Link href="https://github.com/upstash/analytics" target="_blank">
              <h1 className="text-4xl font-bold text-neutral-900 sm:text-center sm:text-6xl hover:underline">
                @upstash/analytics
              </h1>
            </Link>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              {examples.map((e) => (
                <Link
                  href={e.href}
                  key={e.name}
                  className="flex flex-col border border-neutral-300 rounded-lg p-4 hover:border-neutral-400 duration-150"
                >
